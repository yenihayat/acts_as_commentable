    ...
    module Commentable #:nodoc:
      ...
      module SingletonMethods
        ...
        def find_comments_for(obj)
          ...
          #)
          Comment.where("commentable_id = ? and commentable_type = ?", obj.id, commentable).order("created_at DESC")
        end
      ...
      module InstanceMethods
        ...
        def comments_ordered_by_submitted
          ...
          #             :order => "created_at DESC"
          #)
          Comment.where("commentable_id = ? and commentable_type = ?", id, self.class.name).order("created_at DESC")
        end
